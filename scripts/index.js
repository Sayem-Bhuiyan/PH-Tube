...
const loadData = async (id) => {
    const container = document.getElementById('drawing-category');
    ...
    if(id === '1005'){
        ...
        div.innerHTML = `
            <div class="flex flex-col justify-center items-center gap-8">
                ...
                <h2 class="text-[#171717] text-3xl font-bold leading-10 w-[433px] text-center">
    ...
    singleData.forEach((data) => {
        ...
        div.innerHTML = `
            ...
            <div class="flex justify-start gap-3 mt-5 pr-3">
                <div class="avatar">
                ...
                <div class="space-y-2">
                    <h2 class="text-base font-bold leading-7">${data?.title}</h2>
                    <div class="flex items-center gap-3">

                        <p class="text-[#111111B3] text-sm">${data?.authors[0]?.profile_name}</p>
                    ...
                    <p class="text-[#111111B3] text-sm pb-4">${data?.others?.views
                    }</p>
                </div>
